...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    scanner: {
      ...
      inputPlaceholder: 'pega tu enlace o dominio (ej: https://tuweb.com o tuclinica.es)',
  ...
  fr: {
    ...
    scanner: {
      ...
      inputPlaceholder: 'collez votre lien ou domaine (ex : https://votresite.fr ou maclinique.fr)',
  ...
  en: {
    ...
    scanner: {
      ...
      inputPlaceholder: 'paste your link or domain (e.g. https://yoursite.com or myclinic.com)',
