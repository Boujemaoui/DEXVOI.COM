      ...
      >
            ...
            legalLang === 'es' ? (
              ...
              <div className="space-y-6 animate-fadeIn">
                ...
                <section className="space-y-3">
                  ...
                  <p>
                    You can adjust or revoke your cookie preferences at any time by clicking <em>"Cookie Preferences"</em> in the footer or by updating your browser settings (Chrome, Safari, Firefox, Edge).
                  </p>
                </section>
              </div>
            )
        ...
        <div className="px-6 py-4 border-t border-gray-800 bg-[#0A0F1F] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono">
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <span>
              {legalLang === 'es' ? 'Última revisión legal auditada: Septiembre 2026' : 'Last legal compliance audit: September 2026'}
            </span>
          </div>
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            >
              {legalLang === 'es' ? 'Entendido y Aceptar' : 'Understood & Accept'}
            </button>
          </div>
        </div>
      </div>
